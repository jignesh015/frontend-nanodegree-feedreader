...
$(function() {
    ...
    */
    ...
    describe('Initial Entries', function() {
        ...
        it('are loaded in feed container', function(done) {
    ...
    describe('New Feed Selection', function() {
        ...
        var previousContent,
            currentContent;
        var previousContentArray = [];
        var currentContentArray = [];
        ...
        beforeEach(function(done) {
            for(var i = 0; i < feedLen; i++) {
                previousContent = "";
                loadFeed(i, function() {
                    previousContentArray.push(previousContent);
                    currentContent = $('.entry').html();
                    currentContentArray.push(currentContent);
